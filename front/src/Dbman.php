...
final class Dbman
{
    ...
    {
        $dir = ROOT_PATH.'/../databases/default';
...
//var_dump($schema_file_array);
    ...
    public function update($table = null,$showup=false){
        if($showup)$this->showup = true;

        //var_dump(self::$conf);die;
        $db_arr = $this->get_schema_file($table);
